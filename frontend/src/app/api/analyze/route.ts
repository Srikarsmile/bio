...
const USER_PROMPT = (note: string) => `Based on the following clinical presentation, provide a structured stroke triage assessment.
...
function mockAnalyze(note: string) {
